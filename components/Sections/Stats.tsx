const Stats = () => {
  return (
    ...
    >
      <div className="relative w-full max-w-6xl rounded-xl bg-gray-900 overflow-hidden text-white p-10 md:p-20">
        
        {/* Background Image with Overlay */}
        <div 
          className="absolute inset-0 bg-[url('/image%207.png')] bg-cover bg-center opacity-40"
        />
